            ...
            if (isMention) {
                ...
                if (filter.toLowerCase().startsWith('/imagine')) {
                    ...
                    try {
                        ...
                        await conn.sendFile(m.chat, image, 'aiimg.jpg', null, fkontak);
                    } catch (error) {
                        console.error(error)
                ...
                if (!filter) {
                    const empty_response = [
                        ...
                        `${m.name}, saya siap membantu Anda?`,
                    ];
                ...
                const messages = [
                    { role: "system", content: "kamu adalah Wonyoung, Seorang Asisten pribadi yang di buat oleh Nazir yang siap membantu kapan pun!" },
                    { role: "assistant", content: `Saya WonyoungBotz, asisten pribadi yang siap membantu kamu kapan pun! Apa yang bisa saya bantu hari ini?` },
